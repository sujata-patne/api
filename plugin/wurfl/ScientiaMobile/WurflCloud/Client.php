...
class Client {
	...
	/**
	 * The Disable Caching will be used to enable/disable caching
	 * @var AbstractHttpClient
	 */
	 ...
	 */
	public function __construct(Config $config, $disable_caching=false, $cache=null, $http_client=null) {
		$this->config = $config;
	...
	/**
	 * Returns all capability.  If the capability does not exist, returns null.
	 */	
