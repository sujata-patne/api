<!-- BESTSELLER INTERNAL PAGE-->
<?php
    // Portlet Config : 
    $CURRENT_PORTLETID = 13;
...
<div style="height: 30px;
    background: #ccc;
     padding-top: 6px;">
    <h5 style="margin-top: 7px;">Best Seller</h5>
</div>
        ...
        <td height="30" colspan="3" align="right">
            ...
            //TO CHANGE :: PROMO ID
                ...
                <?php  }
                    ...
                    if($_GET['startFrom'] > 0){        ?>
                        <a href="?pg=bestseller.php&startFrom=<?=$_GET['startFrom']-1?>" style="text-decoration:none;"> << Back </a>
              <?php }
                    if($isMoreContent) {          ?>
                        <a href="?pg=bestseller.php&startFrom=<?=$_GET['startFrom']+1?>" style="text-decoration:none;">More >></a>
              <?php }
              } ?>
